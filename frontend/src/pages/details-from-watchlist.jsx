        ...
        <div className="details-container">
          <div className="details-content">
            ...
            <div className="details-info-section">
                  ...
                  <div className="details-meta details-meta-column">
                    <div>
                      <span className="meta-label">
                        {t("detailsfromhome.genre")}:{" "}
                      </span>
                      <span>{anime.genre}</span>
                    </div>
                    <div>
                      <span className="meta-label">
                        {t("detailsfromhome.rating")}:{" "}
                      </span>
              ...
              <NoteList id={id} refreshTrigger={refreshTrigger} />
              ...
              <div className="action-buttons">
                ...
                >
                  ...
                  {t("detailsfromhome.watchtrailer")}
                </button>
                ...
                <AddNote animeID={id} onRefreshNotes={handleRefreshNotes} />
              </div>
            </div>
          </div>
        </div>
